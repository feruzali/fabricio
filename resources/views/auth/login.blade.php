...
<section class="form" id="form">
	...
	<form action="#" class="form-login">
		...
		<input class="form-login__input" type="email" name="login-email" placeholder="Companyname@gmail.com" required="">
		<label class="form-login__label" for="login-password">Password</label>
		<input class="form-login__input" type="password" name="login-password" placeholder="At least 6 characters" required="">
